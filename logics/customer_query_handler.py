...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    return response_to_customer, product_details
...
def process_user_message(user_input):
    ...
    reply, dict_details = generate_response_based_on_course_details(user_input, course_details)

    return reply, dict_details